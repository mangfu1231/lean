...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  ...
  $sql = "SELECT * FROM eventBu INNER JOIN event ON event.ID=eventBu.IdEvt WHERE IdBu='$IdBu';";
  ...
  <tr class="border_bottom">
    ...
    <td><input type="submit" name="id" value="<?php echo $row['IDB'];?>"></td>
  </tr>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "DELETE FROM eventBu WHERE IDB='$IdB';";
